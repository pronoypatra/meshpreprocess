...
This project implements a complete pipeline for processing 3D mesh files through normalization, quantization, reconstruction, and error analysis.
...
Mesh Normalization and Quantization Assignment Implementation
